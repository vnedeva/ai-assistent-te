...
if "messages" not in st.session_state:
    ...
    welcome_msg = "Здравей! Аз съм твоят виртуален асистент по Теоретична електротехника. Искаш ли да преговорим някоя тема или да ти дам пробен въпрос за теста?"
